      ...
      <Menu theme="light" mode="inline">
        ...
        <Menu.Item key="2">
          <NavLink to="/bills">
            <span
              className="icon"
              style={{
                background: page === "bills" ? color : "",
              }}
            >
              {bills}
            </span>
            <span className="label">Fatura Yardımı</span>
          </NavLink>
        </Menu.Item>
        ...
        <Menu.Item key="3">
          <NavLink to="/donation">
            ...
            <span className="label">Bağış</span>
          </NavLink>
        </Menu.Item>
        
        <Menu.Item key="4">
          <NavLink to="/educationSupport">
            <span
              className="icon"
              style={{
                background: page === "educationSupport" ? color : "",
              }}
            >
              {educationSupport}
            </span>
            <span className="label">Eğitim Destek</span>
          </NavLink>
        </Menu.Item>

        <Menu.Item key="5">
          <NavLink to="/petFoodSupport">
            <span
              className="icon"
              style={{
                background: page === "petFoodSupport" ? color : "",
              }}
            >
              {petFoodSupport}
            </span>
            <span className="label">Mama Destek</span>
          </NavLink>
        </Menu.Item>
